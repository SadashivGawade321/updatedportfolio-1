...
const socialLinks = [
    {
        name: 'GitHub',
        url: 'https://github.com/SadashivGawade321',
        icon: <Github />,
        color: 'primary'
    },
    {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/sadashiv-gawade-b658732a9?utm_source=share_via&utm_content=profile&utm_medium=member_android',
        icon: <LinkedIn />,
        color: 'secondary'
    },
    {
        name: 'Email',
        url: 'mailto:24030331246501@dabtu.ac.in',
        icon: <Mail />,
        color: 'accent'
    },
]
...
function Contact() {
    ...
    const handleSubmit = (e) => {
        ...
        fetch('https://formspree.io/f/xdapzypr', {
            method: 'POST',
            body: formDataToSend,
            headers: {
                    ...
                    >
                        ...
                        <div className={styles.contactDetails}>
                            <div className={styles.detailItem}>
                                <Mail />
                                <a href="mailto:24030331246501@dabtu.ac.in">
                                    24030331246501@dabtu.ac.in
                                </a>
                            </div>
                        </div>
