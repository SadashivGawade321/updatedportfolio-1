...
const BarChart3 = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <rect x="7" y="10" width="2" height="11" />
        <rect x="11" y="6" width="2" height="15" />
        <rect x="15" y="8" width="2" height="13" />
    </svg>
)
...
const experiences = [
    {
        id: 0,
        role: "Control Panel Intern",
        company: "SAAN ENGINERS Pvt. Ltd.",
        date: "Jun 2023 - Jul 2023",
        skills: ["PLC", "Ladder Logic", "System Testing",],
    ...
    },
    {
        ...
        skills: ["EDA", "Visualization", "Python", "Pandas","Machine Learning","Power BI"],
