...
const skillCategories = [
    {
        ...
        color: '#FFA116',
        skills: ['Machine Learning', 'Deep Learning', 'TensorFlow', 'PyTorch', 'Neural Networks', 'Data Analysis', 'Computer Vision', 'NLP', 'Scikit-learn', 'Pandas']
    },
    {
        id: 'dev',
        label: 'Development',
        color: '#00d4ff',
        skills: ['Python', 'C++', 'JavaScript', 'React', 'Node.js', 'SQL', 'FastAPI', 'Bash']
    },
    {
        id: 'tools',
        label: 'Tools & Frameworks',
        color: '#FFD60A',
        skills: ['Jupyter Notebook', 'Anaconda', 'Git', 'Docker', 'Linux', 'Data Visualization', 'NumPy', 'Matplotlib']
    }
]
