    ...
    children: [
        {
            ...
            children: [
                ...
                { id: 'tensorflow', label: 'TensorFlow', type: 'skill' },
                { id: 'pytorch', label: 'PyTorch', type: 'skill' },
                { id: 'ml', label: 'Machine Learning', type: 'skill' },
                { id: 'dl', label: 'Deep Learning', type: 'skill' },
                { id: 'cv', label: 'Computer Vision', type: 'skill' },
                { id: 'nlp', label: 'NLP', type: 'skill' },
                { id: 'sklearn', label: 'Scikit-learn', type: 'skill' },
                { id: 'pandas', label: 'Pandas', type: 'skill' },
                { id: 'numpy', label: 'NumPy', type: 'skill' },
            ]
        },
        {
            id: 'dev',
            ...
            color: '#00d4ff',
            children: [
                { id: 'python_dev', label: 'Python', type: 'skill' },
        ...
        },
        {
            ...
            color: '#FFD60A',
            children: [
                { id: 'jupyter', label: 'Jupyter Notebook', type: 'skill' },
                { id: 'anaconda', label: 'Anaconda', type: 'skill' },
                { id: 'git', label: 'Git', type: 'skill' },
                { id: 'docker', label: 'Docker', type: 'skill' },
                { id: 'linux', label: 'Linux', type: 'skill' },
                { id: 'matplotlib', label: 'Matplotlib', type: 'skill' },
                { id: 'plotly', label: 'Plotly', type: 'skill' },
            ]
        }
    ]
}
    ...
    const nodes = useMemo(() => {
        ...
        skillData.children.forEach((cat, i) => {
            ...
            cat.children.forEach((skill, j) => {
                ...
                if (isAIML) {
                    spreadFactor = 1.03 // Wide for AI/ML
                    startOffset = -0.01
                } else if (isTools) {
                    spreadFactor = 0.65 // Reduce gap for Tools
